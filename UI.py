...
model = keras.models.load_model(r"C:\Users\ACER\Desktop\Jupyter\WebApp\Model of Jv2.13 [99.27% acc] Dataset 5.1.1, Arch 1, 100 epoch, 16 batch size.h5")
...
background_image = ImageTk.PhotoImage(Image.open(r"C:\Users\ACER\Desktop\Jupyter\WebApp\Background(1).png"))
